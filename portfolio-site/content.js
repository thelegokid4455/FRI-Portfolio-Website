...
const siteContent = {
  ...
  experience: [
    {period:"2026 — Present", role:"Director / Founder", company:"Ave Ludum Studio · Makassar", description:"Lead game-development projects and advise clients and developers on technical architecture, production workflows and project execution.", visual:"assets/experience/ave-ludum-template.svg", visualAlt:"Game studio workspace template for Ave Ludum Studio in Makassar."},
    ...
    {period:"Jul 2023 — Jul 2024", role:"Software Programmer", company:"PT. Maxxima Innovative · Surabaya", description:"Developed Unity/C# training simulations for government clients across PC and VR, including heavy-vehicle simulation, a ~100 km real-world driving simulator, hardware integration and performance optimization.", visual:"https://maxxima-technology.com/wp-content/uploads/2024/01/ship.png", visualAlt:"3D simulation artwork from Maxxima Innovative Engineering."},
    {period:"Apr 2022 — Sep 2022", role:"Junior Game Programmer", company:"Octaverse Studio · Yogyakarta", description:"Contributed to mobile and PC projects including multiplayer FPS and strategic ship-battle games, plus an endless-runner mobile title.", visual:"assets/experience/octaverse-template.svg", visualAlt:"Game development studio template for Octaverse Studio in Yogyakarta."},
